...
/**
 * This view displays the form to edit an invitee in the back-end
...
?>
    ...
    <h2><?php echo esc_html( __( 'Edit invitee', 'sign-up-list' ) ); ?></h2>
    <form method="post">
    <?php wp_nonce_field( 'sul_invitees_edit', 'sul_invitees_edit_nonce'); ?>
    ...
    <tr>
        ...
        <td><input maxlength="360" size="50" name="email" type="text" 
            value="<?php echo esc_attr( self::safe_value( 'email', $data, $invitee, false ) ); ?>" /></td>
    </tr>
    <tr>
        <td>
