...
/**
 * This view displays the form to edit an entry in the back-end
 * It requires the following variables
 * 
 * $data, an array containing submitted values for the input fields
...
?>
    ...
    <h2><?php echo esc_html( __( 'Edit entry', 'sign-up-list' ) ); ?></h2>
    <form method="post">
    <?php wp_nonce_field( 'sul_entries_edit', 'sul_entries_edit_nonce'); ?>
    <table class="form-table" role="presentation">
    <tbody>
    <tr>
        <th scope="row"><label for="firstname"><?php echo esc_html( __( 'First Name', 'sign-up-list' ) ); ?></label></th>
        <td><input maxlength="255" size="50" name="firstname" type="text" 
            value="<?php echo esc_attr( self::safe_value( 'firstname', $data, $entry ) ); ?>" /></td>
    </tr>
    <tr>
        ...
        <td><input maxlength="255" size="50" name="lastname" type="text" 
            value="<?php echo esc_attr( self::safe_value( 'lastname', $data, $entry ) ); ?>" /></td>
    </tr>
    <tr>
        ...
        <td><input maxlength="360" size="50" name="email" type="text" 
            value="<?php echo esc_attr( self::safe_value( 'email', $data, $entry, false ) ); ?>" /></td>
    </tr>
    ...
    <tr>
        <td>
        <input type="submit" name="save" value="<?php echo esc_attr( __( 'Save entry', 'sign-up-list' ) ); ?>" class="button-primary" />
